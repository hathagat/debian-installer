...
show_ssh_key()
{
dialog --backtitle "Server configuration" --msgbox "Please save the shown SSH privatekey on next page into a textfile on your PC. \n\n
Important: \n
...
create_private_key()
{
dialog --backtitle "Server configuration" --msgbox "You have to download the latest PuTTYgen \n (https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) \n \n
...
show_dkim_key()
{
dialog --backtitle "Server configuration" --msgbox "Please enter the shown DKIM key on next page to you DNS settings \n\n
